...
import editortrees.EditTree.Node;
...
//		
		if(!t1.toString().equals("01" + expected + "10"))
			result = result&& true;
		
		result = result && t1.height() <= maxHeight(t1.size());
//		
		if(t1.height() > maxHeight(t1.size()))
			result = result&& true;
	...
	public void testConcatenateOneEmptyTree() {
		...
		System.out.println("oneEmptyTree");
	...
	public void testConcatenateTwoFullTreesRightLarger() {
		...
		System.out.println("Concat full trees");
		String expected = t1.toString() + t2.toString();
